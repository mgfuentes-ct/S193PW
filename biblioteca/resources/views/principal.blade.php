...
<div class="flex-grow-1 d-flex aling-item-center justify-content-center mt-5">
    <div class="d-flex flex-column justify-content-center aling-items-center text-center full-height">
        <h1 class="display-1">{{__('Bienvenido a la Biblioteca UPQ')}}</h1>
        <p>{{__('Presiona el botón para registrar')}}...</p>
        <a href="{{route('rutaregistro')}}" class="btn btn-outline-info">{{__('Ir al registro')}}</a><br>
        ...
        <div class="d-flex flex-row gap-3 mt-4 justify-content-center">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <p class="card-text">{{__('Nadia López García, nueva coordinadora nacional de Literatura del INBAL, es una poeta mixteca reconocida por su obra en lenguas indígenas y su trayectoria internacional. Entre sus logros destacan el Premio Cenzontle y la beca de la Fundación para las Letras Mexicanas')}}.</p>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <p class="card-text">{{__('La escritora Margaret Atwood, de 84 años, calificó a la inteligencia artificial (IA) como “una poeta de mierda” y dijo no preocuparse por su impacto en la literatura, aunque cree que los jóvenes sí deberían hacerlo. Conocida por The Handmaids Tale, Atwood trabaja ahora en unas memorias donde solo incluye estupideces y catástrofes')}}.</p>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
